...
const PremiumComponent = () => {
  ...
  // Demo data for the cards, including all fields
  const demoPlans = [
    {
      title: "Mobile",
      resolution: "480p",
    ...
    },
    {
      ...
      watchDevices: "1",
      downloadDevices: "2",
      mostPopular: true,  // Adding a "mostPopular" flag
    },
    {
      title: "Standard",
      resolution: "1080p",
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {demoPlans.map((plan, index) => (
          ...
          >
            {/* Display "Most Popular" on the Basic plan */}
            {plan.mostPopular && (
            ...
            <div className="mt-4">
              ...
              {/* Spatial Audio (for Premium Plan) */}
              {plan.audio && (
                <>
                  <hr className="my-4" />
